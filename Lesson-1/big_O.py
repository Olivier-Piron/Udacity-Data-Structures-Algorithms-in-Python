...
def example3(manatees):
    for manatee in manatees:
        ...
        # then we would need 5+5+5+5 steps. This logic simplifies to the number of manatees times the number of properties, 
        # or O(nm).
...
def example4(manatees):
    ...
    print oldest_manatee
        ...
        # Again we have nested for loops. This time we're iterating over the manatees list twice - every 
        # time we see a manatee, we compare it to every other manatee's age. We end up with O(nn), or O(n^2) 
