# BST a(Binary Search Tree) re sorted, every value on the left of a particular node is smaller and every value on the right is larger
# It can be unbalanced (https://www.quora.com/What-is-an-unbalanced-binary-tree-and-what-are-its-uses), it's the worse case for 
